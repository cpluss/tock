...
impl MPU {
    ...
    pub unsafe fn read_from_acc(&self) -> [i16; MPU_NUM_AXES] {
        ...
        self.sensor
            .get()
            .read_from_reg(MPU_ACCEL_XOUT_H, &mut buf, MPU_DATA_SIZE as u8);
        self.sensor.get().deselect();
    ...
    pub unsafe fn read_from_gyro(&self) -> [i16; MPU_NUM_AXES] {
        ...
        self.sensor
            .get()
            .read_from_reg(MPU_GYRO_XOUT_H, &mut buf, MPU_DATA_SIZE as u8);
        self.sensor.get().deselect();
    ...
    unsafe fn configure_pins(&self) {
        ...
        ioc::IOCFG[MPU_POWER_IOID as usize]
            .set_drv_strength(ioc::CurrentMode::Current4mA, ioc::DriveStrength::Max);
